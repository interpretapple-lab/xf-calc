...
class GenerateReport():
    ...
    def __saveResultsPlots(self):
        ...
        plt.savefig("visualization/results.png")
    ...
    def __saveInputPlots(self):
        ...
        plt.savefig("visualization/input.png")
    ...
    def _generatePDF(self, filename="visualization/report"+datetime.strftime(datetime.now(),"%d%m%Y_%H%M%S")+".pdf",dateTime = datetime.now()):
        ...
        pdf.image("visualization/input.png", 62, 25, 90,45)
        pdf.image("visualization/results.png", 5, 78, WIDTH-8,HEIGHT-95)
